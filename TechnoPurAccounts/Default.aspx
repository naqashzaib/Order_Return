        ...
        <div class="account-pages my-5">
            <div class="container">
                <div class="row justify-content-center" >
                    <div class="col-md-8 col-lg-6 col-xl-5" style="border-radius: 15px; background-color: #00000087;">
                        <img src="images/logo2.png" style="height: 91px;margin-left: 30%;    margin-top: 7%;" />
                        ...
                        <div class="card mt-4" >
                            ...
                            <div class="card-body">
                                <form action="#" class="p-2">
                                    ...
                                    <div class="form-group mb-3">
                                        <a href="#" class="text-muted float-right" data-toggle="modal" data-target="#myModal" style="color:#F7F7F7">Forgot your password?</a>
                                        <br/>
