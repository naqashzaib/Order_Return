<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="add_company.aspx.cs" Inherits="TechnoPurAccounts.Return_Order.add_company" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btnaddstd').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        swal({
                            title: "Done",
                            text: "Company info succefully saved",
                            icon: "success",
                        });
                        showStdInfo();
            ...
            $(document).on('click', '.delstdinfo', function () {
                ...
                if (confirm("Are you really want to delete this Company info?") == true) {
                    $.ajax({
                        headers: {
                            "Authorization": localStorage["access_token"]
                        },
                        url: url + "api/CompanyDelete?company_id=" + company_id,
                        async: false,
                        method: 'Delete',
                        success: function (data) {
                            swal({
                                title: "Done",
                                text: "Company info Succefully Deleted",
                                icon: "success",
                            });
                            showStdInfo();
                        },
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Add Companies</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    <hr />
                    <button type="button" style="background: #1a2942;color:#ffffff" class="btn" id="btnAddstd" data-toggle="modal" data-target="#myModal">Add New Copmpany</button>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="insertHead"><strong>Add Company Info</strong></h4>
                        <h4 class="modal-title" id="updateHead"><strong>Edit Company Info</strong></h4>
                    ...
                    <div class="modal-body">
                        <form class="" action="#" autocomplete="off" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="txtcompany" type="text" name="" placeholder="Enter Company Name" class="form-control" />
                            </div>
                            <div class="form-group">
